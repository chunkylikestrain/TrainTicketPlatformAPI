...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: UB3Y0zNSaGRs/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__cukn8)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames("all", sty.freeBox__udaH8)}>
            <div className={classNames("all", "__wab_text", sty.text__ogxHe)}>
              <React.Fragment>
                {(() => {
                  try {
                    return $props.label;
        ...
        {(() => {
          ...
          <BaseText2
            ...
            slot={"description"}
          >
            <div className={classNames("all", "__wab_text", sty.text__waAzr)}>
