...
import { _useStyleTokens } from "./PlasmicStyleTokensProvider"; // plasmic-import: rAgsy6LoQc6tUTiovYwby4/styleTokensProvider

import "@plasmicapp/react-web/lib/plasmic.css";

import "./plasmic.css"; // plasmic-import: rAgsy6LoQc6tUTiovYwby4/projectcss
import sty from "./PlasmicButton2.module.css"; // plasmic-import: nuCfU4RSq3g6/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: Lomn-wMNVST5/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: nZLlaX3_kBhI/icon
  ...
  return (
    <BaseButton
      ...
      className={classNames(
        "__wab_instance",
        "root_reset_rAgsy6LoQc6tUTiovYwby4",
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__gsMdq, {
          [sty.freeBoxcolor_neutral__gsMdqEl2Za]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_white__gsMdq8O3Ku]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__gsMdqq7S21]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__gsMdqCcJy]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__gsMdqgJt57]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__gsMdq7KiA]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__gsMdqr9KqT]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__gsMdqorri7]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__gsMdqorri7MTbP]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames("all", sty.freeBox__xMZzR, {
            [sty.freeBoxcolor_neutral__xMZzREl2Za]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__xMZzREl2ZaHqipq]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__xMZzRJjLQy]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__xMZzRCcJy]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__xMZzR7KiA]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__xMZzRr9KqT]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__xMZzRorri7]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg___4Dl7E)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__tW2L6)}>
              {"Text"}
            </div>
          ),
          value: args.label,
        ...
        <div
          className={classNames("all", sty.freeBox___9Cow2, {
            [sty.freeBoxiconEnd___9Cow2LSacK]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge___9Cow2CcJy]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___9Cow27KiA]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___9Cow2R9KqT]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames("all", sty.svg__tivKv)}
                role={"img"}
              />
            ),
