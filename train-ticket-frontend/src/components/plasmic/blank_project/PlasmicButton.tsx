...
import sty from "./PlasmicButton.module.css"; // plasmic-import: rrUIpKuy-nIm/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__a2L3J, {
          [sty.freeBoxcolor_neutral__a2L3JkzRlL]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__a2L3JtXZi]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__a2L3JnHeLb]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__a2L3J6QnUd]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__a2L3Je59Wa]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__a2L3JFvDo5]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__a2L3J2VIyt]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__a2L3J2VIytGcRzN]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames("all", sty.freeBox__tX8OO, {
            [sty.freeBoxcolor_neutral__tX8OOkzRlL]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__tX8OOTwfGr]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__tX8OOnHeLb]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__tX8OOe59Wa]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__tX8OOFvDo5]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__tX8OO2VIyt]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__tX8OODrtYoKzRlL]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__orOyF)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__dAu2E)}>
              {"Text"}
            </div>
          ),
          value: args.label,
        ...
        <div
          className={classNames("all", sty.freeBox__ah2U, {
            [sty.freeBoxiconEnd__ah2UsdVhQ]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__ah2UnHeLb]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__ah2Ue59Wa]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__ah2UFvDo5]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames("all", sty.svg__lmJs)}
                role={"img"}
              />
            ),
