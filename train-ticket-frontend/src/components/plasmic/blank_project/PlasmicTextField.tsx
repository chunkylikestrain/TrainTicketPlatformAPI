...
import TextInput from "../../TextInput"; // plasmic-import: f9ib68nfFol9/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 4BfKsvycqL5p/component
import Description from "../../Description"; // plasmic-import: RuqjBG4NVF-B/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 3m7YIkSS31YL/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames("all", sty.freeBox__vqT8A, {
          [sty.freeBoxiconEnd__vqT8A3Tl7]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__vqT8A1LmyT]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__vqT8AxsAfV]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox___9S3I, {
            [sty.freeBoxiconStart___9S3I1LmyT]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___9S3IxsAfV]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__eqNwX)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox___4HfK, {
            [sty.freeBoxiconEnd___4HfK3Tl7]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___4HfK1LmyT]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__sob24)}
                role={"img"}
              />
            ),
